...
public class NoteReminderReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_NOTE_TITLE = "com.lennydennis.notekeeper.extra.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.lennydennis.notekeeper.extra.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID = "com.lennydennis.notekeeper.extra.NOTE_ID";
