...
public class DatabaseDataWorker {
    ...
    private void insertCourse(String courseId, String title) {
        ...
        long newRowId = mSQLiteDatabase.insert(NoteKeeperDatabaseContract.CourseInfoEntry.TABLE_NAME, null, values);
    }
     ...
     private void insertNote(String courseId, String title, String text) {
        ...
        long newRowId = mSQLiteDatabase.insert(NoteKeeperDatabaseContract.NoteInfoEntry.TABLE_NAME, null, values);
    }
